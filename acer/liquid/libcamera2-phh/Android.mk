...
<html>
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="chrome=1">
        <title>acer/liquid/libcamera2-phh/Android.mk at ics from thepasto/liquidCM_devicetree - GitHub</title>
...
<meta content="1qzUB7BSBAtNC5l0zvs8fiypxvY7+fPXMhKU3Vxi2EU=" name="csrf-token" />
    ...
    <script src="https://a248.e.akamai.net/assets.github.com/javascripts/bundles/github-724a1478428e953614c0459ba27f5d900fc109be.js" type="text/javascript"></script>
      ...
      <link rel='permalink' href='/thepasto/liquidCM_devicetree/blob/1800e3d784c27ad21390f87a8d09e97dec2ae9ab/acer/liquid/libcamera2-phh/Android.mk'>
  ...
  <body class="logged_out page-blob  vis-public fork env-production ">
    ...
    <ul class="top-nav logged_out">
      ...
      <li class="login"><a href="https://github.com/login?return_to=%2Fthepasto%2FliquidCM_devicetree%2Fblob%2Fics%2Facer%2Fliquid%2Flibcamera2-phh%2FAndroid.mk">Login</a></li>
    </ul>
            ...
            <div class="body pane-selector commitish-selector js-filterable-commitishes">
              <div class="filterbar">
                ...
                <div class="commitish-item branch-commitish selector-item">
                  <h4>
                      <a href="/thepasto/liquidCM_devicetree/blob/ics/acer/liquid/libcamera2-phh/Android.mk" data-name="ics">ics</a>
                  </h4>
                </div>
                <div class="commitish-item branch-commitish selector-item">
                  <h4>
                      <a href="/thepasto/liquidCM_devicetree/blob/master/acer/liquid/libcamera2-phh/Android.mk" data-name="master">master</a>
                  </h4>
                </div>
...
<!-- block_view_fragment_key: views4/v8/blob:v14:1895653:thepasto/liquidCM_devicetree:f2144a0eab84867eee3c4088aa692d921d595544:c6138c1e3ec793c421acc063c9b669b7 -->
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="acer/liquid/libcamera2-phh/Android.mk/">
      ...
      <param NAME="FlashVars" value="id=clippy_1250&amp;copied=copied!&amp;copyto=copy to clipboard">
      ...
      <embed src="https://a248.e.akamai.net/assets.github.com/flash/clippy.swf?1302750674?v5"
             ...
             FlashVars="id=clippy_1250&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="acer/liquid/libcamera2-phh/Android.mk/" data-permalink-url="/thepasto/liquidCM_devicetree/blob/1800e3d784c27ad21390f87a8d09e97dec2ae9ab/acer/liquid/libcamera2-phh/Android.mk" data-title="acer/liquid/libcamera2-phh/Android.mk at ics from thepasto/liquidCM_devicetree - GitHub" data-type="blob">
          <ul class="big-actions">
            <li><a class="file-edit-link minibutton js-rewrite-sha" href="/thepasto/liquidCM_devicetree/edit/1800e3d784c27ad21390f87a8d09e97dec2ae9ab/acer/liquid/libcamera2-phh/Android.mk" data-method="post" rel="nofollow"><span>Edit this file</span></a></li>
          </ul>
        ...
        <div id="files">
          <div class="file">
            <div class="meta">
              ...
              <ul class="actions">
                <li><a href="/thepasto/liquidCM_devicetree/raw/ics/acer/liquid/libcamera2-phh/Android.mk" id="raw-url">raw</a></li>
                  <li><a href="/thepasto/liquidCM_devicetree/blame/ics/acer/liquid/libcamera2-phh/Android.mk">blame</a></li>
                <li><a href="/thepasto/liquidCM_devicetree/commits/ics/acer/liquid/libcamera2-phh/Android.mk" rel="nofollow">history</a></li>
              </ul>
            </div>
...
<span id="L30" rel="#L30">30</span>
          ...
          <td width="100%">
                <div class="highlight"><pre><div class='line' id='LC1'><span class="c"># When zero we link against libmmcamera; when 1, we dlopen libmmcamera.</span></div><div class='line' id='LC2'><span class="nv">DLOPEN_LIBMMCAMERA</span><span class="o">:=</span>1</div><div class='line' id='LC3'><br/></div><div class='line' id='LC4'><br/></div><div class='line' id='LC5'>LOCAL_PATH:<span class="o">=</span> <span class="k">$(</span>call my-dir<span class="k">)</span></div><div class='line' id='LC6'><br/></div><div class='line' id='LC7'><span class="cp">include $(CLEAR_VARS)</span></div><div class='line' id='LC8'><br/></div><div class='line' id='LC9'>LOCAL_SRC_FILES:<span class="o">=</span> QualcommCameraHardware.cpp</div><div class='line' id='LC10'><br/></div><div class='line' id='LC11'>LOCAL_CFLAGS:<span class="o">=</span> -DDLOPEN_LIBMMCAMERA<span class="o">=</span><span class="k">$(</span>DLOPEN_LIBMMCAMERA<span class="k">)</span></div><div class='line' id='LC12'><br/></div><div class='line' id='LC13'>LOCAL_CFLAGS+<span class="o">=</span> -DNUM_PREVIEW_BUFFERS<span class="o">=</span>4 -D_ANDROID_</div><div class='line' id='LC14'><br/></div><div class='line' id='LC15'>LOCAL_C_INCLUDES+<span class="o">=</span> <span class="se">\</span></div><div class='line' id='LC16'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">$(</span>TARGET_OUT_HEADERS<span class="k">)</span>/mm-camera <span class="se">\</span></div><div class='line' id='LC17'>&nbsp;&nbsp;&nbsp;&nbsp;<span class="k">$(</span>TARGET_OUT_HEADERS<span class="k">)</span>/mm-still/jpeg <span class="se">\</span></div><div class='line' id='LC18'><br/></div><div class='line' id='LC19'>LOCAL_SHARED_LIBRARIES:<span class="o">=</span> libutils libui libcamera_client liblog libcutils</div><div class='line' id='LC20'><br/></div><div class='line' id='LC21'>LOCAL_SHARED_LIBRARIES+<span class="o">=</span> libbinder</div><div class='line' id='LC22'><span class="cp">ifneq ($(DLOPEN_LIBMMCAMERA),1)</span></div><div class='line' id='LC23'>LOCAL_SHARED_LIBRARIES+<span class="o">=</span> liboemcamera</div><div class='line' id='LC24'><span class="cp">else</span></div><div class='line' id='LC25'>LOCAL_SHARED_LIBRARIES+<span class="o">=</span> libdl</div><div class='line' id='LC26'><span class="cp">endif</span></div><div class='line' id='LC27'><br/></div><div class='line' id='LC28'>LOCAL_MODULE:<span class="o">=</span> libcamera</div><div class='line' id='LC29'><span class="cp">include $(BUILD_SHARED_LIBRARY)</span></div><div class='line' id='LC30'><br/></div></pre></div>
          </td>
        </tr>
      </table>
  </div>
...
<div class="lower_footer">
  <div class="container" class="clearfix">
    ...
    <![if !IE]><div id="legal"><![endif]>
      ...
      <p>&copy; 2012 <span id="_rrt" title="0.08701s from fe5.rs.github.com">GitHub</span> Inc. All rights reserved.</p>
